...
class Fretboard:
    ...
    def get_chord_at(self, chord):
        return self.chord_map[chord]
    
    def get_scale_at(self, scale):
    ...
    def play_scale(self, notes):
        scale = self.get_scale_at(notes)
        self.play_obj = self.wav_obj.from_wave_file("Assets/" + scale + ".wav").play()
